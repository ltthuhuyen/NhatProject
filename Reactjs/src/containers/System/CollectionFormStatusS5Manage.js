...
class CollectionFormStatusS5Manage extends Component {
  ...
  render() {
    ...
    const currentTodos = arrCollectionFormsStatusS5.slice(
      indexOfFirstTodo,
      indexOfLastTodo
    );
    ...
    for (
      let i = 1;
      i <= Math.ceil(arrCollectionFormsStatusS5.length / todosPerPage);
      i++
    ) {
      pageNumbers.push(i);
    }
      ...
      <>
        ...
        <div className="main_content">
          ...
          <div className="row title d-flex">
            <div className="col-10 title-manage">ĐƠN BỊ HỦY </div>
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(CollectionFormStatusS5Manage)
);
