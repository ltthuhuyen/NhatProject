...
import {getCancelledCollectionForm} from '../../services/collectionformService'
import NavAdmin from '../../components/NavAdmin';

class CollectionFormStatusS5Manage extends Component {
    constructor(props){
        super(props);
        this.state = {
            arrCollectionForms: [],
    ...
    componentDidMount(){
        this.getCollectionFormStatusS5();    
        this.props.getStatusStart();
        

    }
    
    getCollectionFormStatusS5 = async () => {
        let response = await getCancelledCollectionForm('ALL');
        console.log('collection-form-S5', response)
    ...
    render() {
        ...
        console.log('arrCollectionFormsStatusS5', arrCollectionFormsStatusS5)
            ...
            <div className="main_content">
                ...
                <div className='row content'>
                    ...
                    <Table >
                        ...
                        {
                                arrCollectionFormsStatusS5 && arrCollectionFormsStatusS5.map((item, index) => {
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(CollectionFormStatusS5Manage));
