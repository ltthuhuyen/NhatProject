...
class CollectionFormStatusS2Manage extends Component {
  ...
  render() {
    ...
    const currentTodos = arrCollectionFormsStatusS2.slice(
      indexOfFirstTodo,
      indexOfLastTodo
    );
    ...
    for (
      let i = 1;
      i <= Math.ceil(arrCollectionFormsStatusS2.length / todosPerPage);
      i++
    ) {
      pageNumbers.push(i);
    }
      ...
      <>
        ...
        <div className="main_content">
          ...
          <div className="row title d-flex">
            <div className="col-10 title-manage">ĐƠN CHỜ XÁC NHẬN </div>
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(CollectionFormStatusS2Manage)
);
