...
class SearchNews extends Component {
  ...
  async componentDidMount() {
    ...
    await this.getAllSearchNewsFromReact();
  ...
  getAllSearchNewsFromReact = async () => {
    if (
      this.props.match &&
      ...
      let response = await searchNews(search);
        ...
        <div className="main_content">
          ...
          <div className="wrapper-manage shadow-sm ">
            <div className="row title d-flex">
              <div className="col-6 title-manage">TÌM KIẾM TIN TỨC</div>
            ...
            <div className="row content">
              <Table>
                ...
                <tbody className="tbody">
                  {arrSearchNews &&
                    arrSearchNews.length > 0 &&
                    arrSearchNews.map((item, index) => {
                      let imageBase64 = "";
                      if (item.avatar) {
