...
class CollectionFormStatusS3 extends Component {
    ...
    getCollectionFormOfRecipientStatusS3 = async () => {
        let response = await getCollectionFormOfWaittingRecipient(this.state.recipientId);
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(CollectionFormStatusS3));
