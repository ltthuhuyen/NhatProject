...
class CollectionFormStatusS5 extends Component {
    ...
    getCollectionFormOfRecipientStatusS5 = async () => {
        let response = await getCollectionFormOfCancelledRecipient (this.state.recipientId);
                                ...
                                <div className='d-flex'>
                                    {
                                        ...
                                        <p className='status-s4'><BsIcons.BsX className='icon'/> {item.statusTypeData.valueVi}</p>
                                        : 
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(CollectionFormStatusS5));
