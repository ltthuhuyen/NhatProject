...
class CollectionFormStatusS1Manage extends Component {
    ...
    render() {
        ...
        console.log('arrCollectionFormsStatusS1', arrCollectionFormsStatusS1)
                        ...
                        <tbody className='tbody'>
                        {
                                ...
                                return (
                                    <tr key={index}>
                                        ...
                                        <td><button type="button" className="btn btn-detail px-2 " onClick={() => this.handleLook(item)}><BsIcons.BsInfoCircle className='icon'/> Chi tiết</button></td>
                                    </tr>
                                        )
                                })
                            }
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(CollectionFormStatusS1Manage));
