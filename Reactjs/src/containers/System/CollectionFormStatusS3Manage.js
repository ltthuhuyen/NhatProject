...
import {getWaittingCollectionForm} from '../../services/collectionformService'
...
class CollectionFormStatusS3Manage extends Component {
    ...
    componentDidMount(){
        this.getCollectionFormStatusS3();    
        this.props.getStatusStart();
        

    }
    
    getCollectionFormStatusS3 = async () => {
        let response = await getWaittingCollectionForm('ALL');
    ...
    render() {
        ...
        console.log('arrCollectionFormsStatusS3', arrCollectionFormsStatusS3)
            ...
            <div className="main_content">
                ...
                <div className='row content'>
                    ...
                    <Table >
                        ...
                        {
                                arrCollectionFormsStatusS3 && arrCollectionFormsStatusS3.map((item, index) => {
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(CollectionFormStatusS3Manage));
