            ...
            if (res && res.errCode === 0) {
                this.setState({
                   competitionDetail: res.competitions,
                    ...
                    console.log('competitionDetail', this.state.competitionDetail)
                })
            }
                ...
                <div className="competition-detail">
                    ...
                    <div className="competition-detail-content">
                        <div className="frames-header row">
                            ...
                            <div className="cont-content mt-3" dangerouslySetInnerHTML={{ __html:competitionDetail.contentHTML }}>
                        </div>
                    </div>
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(DetailCompetition));
