  ...
  class Schedule extends Model {
    ...
    static associate(models) {
      // define association here
        ...
        Schedule.belongsTo(models.Address, { foreignKey: 'addressId', targetKey: 'id', as: 'addressData' })
        Schedule.belongsTo(models.User, { foreignKey: 'recipientId', targetKey: 'id', as: 'recipientData' })
